...
<#-- @ftlvariable name="item" type="org.onehippo.forge.repository.server.remoting.davex.beans.Blogpost" -->
<#-- @ftlvariable name="author" type="org.onehippo.forge.repository.server.remoting.davex.beans.Author" -->
